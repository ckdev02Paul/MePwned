...
TESTS = [
    ...
    # ═══ Additional HIGH/MEDIUM Tests ═══
    {"id": "SA-04", "module": "SuperAdmin", "severity": "HIGH",
     "title": "Unauth user enumeration — validate_student_name",
     "method": "GET", "path": "/student/enrollment/check/duplication",
     "params": {"firstname": "test", "lastname": "test"}, "needs_auth": False, "check": _check_json_data},
    {"id": "S-02", "module": "Student", "severity": "HIGH",
     "title": "Unauth SMS blast trigger",
     "method": "GET", "path": "/apismsblast",
     "params": {}, "needs_auth": False, "check": _check_unauth},
    {"id": "S-02b", "module": "Student", "severity": "HIGH",
     "title": "Unauth SMS push to bunker",
     "method": "GET", "path": "/apipushtobunker/test/09000000000/test",
     "params": {}, "needs_auth": False, "check": _check_unauth},
    {"id": "P-01a", "module": "Parent", "severity": "HIGH",
     "title": "Unauth parent enrollment record",
     "method": "GET", "path": "/parent/enrollment/record",
     "params": {}, "needs_auth": False, "check": _check_unauth},
    {"id": "P-01b", "module": "Parent", "severity": "HIGH",
     "title": "Unauth parent billing",
     "method": "GET", "path": "/parent/enrollment/billing",
     "params": {}, "needs_auth": False, "check": _check_unauth},
    {"id": "CV2-11", "module": "Cashier", "severity": "MEDIUM",
     "title": "Uncapped per_page parameter — resource exhaustion",
     "method": "GET", "path": "/students",
     "params": {"per_page": "99999", "search": "a"}, "needs_auth": True, "check": _check_json_data,
     "note": "Check if response honors cap (≤100 results)"},
    {"id": "C-03a", "module": "College", "severity": "HIGH",
     "title": "ECR grade approve — auth-only (no role)",
     "method": "GET", "path": "/college/grade/ecr/approve",
     "params": {}, "needs_auth": True, "check": _check_unauth},
    {"id": "C-04a", "module": "College", "severity": "HIGH",
     "title": "Dean courses — auth-only (no role)",
     "method": "GET", "path": "/dean/courses/",
     "params": {}, "needs_auth": True, "check": _check_unauth},
]
